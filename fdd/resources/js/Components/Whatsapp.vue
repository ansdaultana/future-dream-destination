...
const openmessage=()=>{show.value=!show.value}
...
<template>
    ...
    <div class="fixed bottom-5 right-5">
        ...
        <div>
            <div @click.prevent="openmessage"
            class="shadow-lg rounded-full p-4 bg-[#06CA00] transition-transform hover:scale-105 ease-in-out duration-300 cursor-pointer">
